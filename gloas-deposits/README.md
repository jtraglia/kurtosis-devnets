...
| s10 | Post  | Continuously submits ~8,000 builder deposits with unique pubkeys, where 1% have invalid signatures. |
| s11 | Post  | Continuously submits ~8,000 builder deposits with unique pubkeys, where 50% have invalid signatures. |
| s12 | Post  | Continuously submits ~8,000 builder deposits with unique pubkeys, where 100% have invalid signatures. |
